...
$res = Update_pro($file_name, $desc, $pro_id);
// insert data :
if($res == true){
header("LOCATION:Allportfolios.php");
  ...
  $pro_id = $_GET['proid'];
  $data = Get_portfolios_By_Id($pro_id);
}
...
<div class="alert <?php if(isset($success)) : ?> alert-success <?php else : ?> alert-danger <?php  endif; ?> " role="alert">
        <ul>
              ...
              <form action="updateportfolio.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="desc" id="summernote" cols="8" rows="5"><?php echo $data['description']; ?></textarea>
                </div>
                  <img src="uploads/<?php echo $data['img'];?>" width="200rem">
                  <div class="form-group">
