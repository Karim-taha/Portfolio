...
// insert data :
if(!empty($file_name) && !empty($desc) && !empty($user_id)){
$res = Add_new_pro($file_name, $desc, $user_id);
              ...
              <form action="portfolio.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="desc" id="summernote" cols="8" rows="5"></textarea>
                </div>
