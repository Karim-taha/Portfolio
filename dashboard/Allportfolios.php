...
<div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><img src="uploads/<?php echo $da['img']; ?>" height="100rem" width="100rem" alt="image"></td>
                    <td style="text-align: center;"><a href="updatePortfolio.php?proid=<?php echo $da['id']; ?>" class="btn btn-outline-warning">Update</td>
                    <td style="text-align: center;"><a href="deletePortfolio.php?proid=<?php echo $da['id']; ?>" class="btn btn-outline-danger">Delete</td>
                  </tr>
                  <?php endforeach; ?>
                  </tbody>
                </table>
